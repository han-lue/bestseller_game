  ...
  return (
    <div className='h-screen w-screen bg-gray text-white'>
      ...
      <div className='flex flex-col w-full h-full justify-center items-center gap-12'>
            ...
            <Link to="/game" relative="path"><button className='bg-white text-black p-4 self-center rounded-lg font-semibold hover:bg-opacity-80'>Start Playing</button></Link>
        </div>
